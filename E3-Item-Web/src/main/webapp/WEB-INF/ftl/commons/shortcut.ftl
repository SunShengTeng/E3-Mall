    ...
    <ul class="fr topTh">
      <li class="login" id="login">
      	<span id="loginbar" style="margin-right: 15px;">
	      	<a href="http://sso.e3mall.com/page/login?returnUrl=http://www.e3mall.com/">请登录</a>
      	</span>
      	<a href="http://sso.e3mall.com/page/register?returnUrl=http://www.e3mall.com/">免费注册</a>
      </li>
