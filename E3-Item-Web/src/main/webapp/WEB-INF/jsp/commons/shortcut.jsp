    ...
    <ul class="fr topTh">
      <li class="login" id="login">
      	<span id="loginbar" style="margin-right: 15px;">
	      	<a href="http://sso.e3mall.com/page/login/?returnUrl=http://item.e3mall.com/item/${item.id}.html">请登录</a>
      	</span>
      	<a href="https://http://sso.e3mall.com/page/register?returnUrl=http://item.e3mall.com/item/${item.id}.html">免费注册</a>
      </li>
