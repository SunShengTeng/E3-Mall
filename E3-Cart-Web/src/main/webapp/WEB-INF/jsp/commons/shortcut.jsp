    ...
    <ul class="fr topTh">
      <li class="login" id="login">
      	<span id="loginbar" style="margin-right: 15px;">
	      	<a href="http://sso.e3mall.com/page/login?redirectUrl=http://cart.e3mall.com/cart/cart">请登录</a>
      	</span>
      	<a href="http://sso.e3mall.com/page/register?redirectUrl=http://cart.e3mall.com/cart/cart">免费注册</a>
      </li>
